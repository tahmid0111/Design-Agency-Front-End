            ...
            <div className="subscribe-area container mx-auto text-center my-8 py-8">
                ...
                <form>
                    <div className="form-area relative">
                        ...
                        <button className='subscribe-btn px-[3%] py-3 bg-orange-500 text-white rounded-xl absolute top-[8%] left-[68%] sm:left-[72.3%] md:left-[71.8%] lg:left-[64.3%] xl:left-[61.7%] 2xl:left-[62.7%] font-medium'>Subscribe</button>
